...
layout: post
title: fr birimi
description: CSS Grid ile gelne fr birimini anlattık. fr nedir, fr nasıl kullanılır
lang: tr_TR
...
Yaptığımız tanımla hiç bir hesaplamaya gerek duymadık. fr tanımı bizim yerimize diğer değerlerden sonra kalan alanı hesapladı ve sonucu üretti. Büyük kolaylık.
